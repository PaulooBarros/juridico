...
window.MOCK = (() => {
  const CLIENTES = [
    ...
    { id: "c-002", nome: "Helena Marques de Andrade", tipo: "PF", doc: "184.502.339-12", email: "helena.marques@outlook.com", tel: "(11) 99182-4471", cidade: "São Paulo / SP", desde: "2022-08", casosAtivos: 2, status: "ativo" },
    ...
    { id: "c-009", nome: "TechBras Sistemas e Serviços", tipo: "PJ", doc: "32.557.108/0001-91", email: "legal@techbras.io", tel: "(11) 4003-8800", cidade: "São Paulo / SP", desde: "2022-05", casosAtivos: 2, status: "ativo" },
  ...
  const CASOS = [
    ...
    { id: "p-2024-00498", numero: "1024891-77.2024.8.26.0100", clienteId: "c-002", clienteNome: "Helena M. Andrade", tipo: "Família — Inventário", area: "Família", status: "ativo", fase: "Petição inicial", responsavel: "Dr. André Furtado", prazo: "2026-06-04", valor: 0, criadoEm: "2024-04-22", vara: "5ª Vara de Família — São Paulo" },
    { id: "p-2023-00712", numero: "5009124-08.2023.4.03.6100", clienteId: "c-003", clienteNome: "Têxtil Vale do Itajaí", tipo: "Tributário — Execução fiscal", area: "Tributário", status: "ativo", fase: "Embargos", responsavel: "Dra. Marina Costa", prazo: "2026-05-29", valor: 2480000, criadoEm: "2023-08-17", vara: "12ª Vara Federal — São Paulo" },
    ...
    { id: "p-2024-00505", numero: "5012088-12.2024.4.03.6182", clienteId: "c-009", clienteNome: "TechBras Sistemas", tipo: "Empresarial — Contratos", area: "Empresarial", status: "ativo", fase: "Negociação", responsavel: "Dra. Júlia Werneck", prazo: "2026-05-28", valor: 320000, criadoEm: "2024-05-02", vara: "Câmara CAM-CCBC — São Paulo" },
    ...
    { id: "p-2024-00800", numero: "0010220-08.2024.8.26.0100", clienteId: "c-009", clienteNome: "TechBras Sistemas", tipo: "Propriedade Intelectual", area: "Empresarial", status: "ativo", fase: "Liminar concedida", responsavel: "Dra. Júlia Werneck", prazo: "2026-06-22", valor: 240000, criadoEm: "2024-09-10", vara: "2ª Vara Empresarial — São Paulo" },
